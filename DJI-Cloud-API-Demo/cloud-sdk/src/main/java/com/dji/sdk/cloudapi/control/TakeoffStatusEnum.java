...
public enum TakeoffStatusEnum {
    ...
    TAKEOFF_PREPARE("takeoff_prepare", "The drone is in the takeoff preparation phase."),
    ...
    LANDING_PREPARE("landing_prepare", "The drone is in the landing preparation phase."),
